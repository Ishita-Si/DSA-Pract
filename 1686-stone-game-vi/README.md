...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/stone-game-vi/)

**Topics:** Array, Math, Greedy, Minimax, Sorting, Heap (Priority Queue), Game Theory, Zero-Sum Game
...
**My Solution:** [1686-Stone-Game-VI.cpp](./1686-Stone-Game-VI.cpp)
