...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/insert-greatest-common-divisors-in-linked-list/)
...
**My Solution:** [2807-Insert-Greatest-Common-Divisors-in-Linked-List.cpp](./2807-Insert-Greatest-Common-Divisors-in-Linked-List.cpp)
